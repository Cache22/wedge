namespace WhatIsMyIP
{
    ...
    public static class ExternalIPFetcher
    {
        ...
        public static async Task<IPAnswer> GetAddressAsync(params CancellationToken[] cancellationTokens)
        {
            if (cancellationTokens == null || cancellationTokens.Length == 0) cancellationTokens = new CancellationToken[] { CancellationToken.None };
            CancellationTokenSource cts = CancellationTokenSource.CreateLinkedTokenSource(cancellationTokens);
